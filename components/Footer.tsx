          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-slate-400 hover:text-pink-500 transition-colors p-2 hover:bg-slate-800 rounded-lg group"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-blue-500 transition-colors p-2 hover:bg-slate-800 rounded-lg group"
                aria-label="LinkedIn"
              >
                <svg
                  className="w-5 h-5 fill-current"
