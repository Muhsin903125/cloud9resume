...
export const generateInsights = (
  ...
  return {
    insights,
    strengths:
      strengths.length > 0 ? strengths : ["Resume has relevant content"],
    weaknesses,
    recommendations,
  };
};
      ...
      <div class="container">
        ...
        ${
          ...
          <div class="section">
            ...
            ${analysis.strengths
              .map((s) => `<div class="strength">✓ ${s}</div>`)
              .join("")}
          </div>
        `
            : ""
        ...
        ${
          ...
          <div class="section">
            ...
            ${analysis.weaknesses
              .map((w) => `<div class="weakness">• ${w}</div>`)
              .join("")}
          </div>
        `
            : ""
        ...
        <div class="footer">
          <p>Cloud9Profile - ATS Compatibility Checker</p>
