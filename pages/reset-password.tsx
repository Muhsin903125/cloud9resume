...
const ResetPasswordPage: NextPage = () => {
  ...
  if (!tokenValid) {
    return (
      <>
        <Head>
          <title>Invalid Reset Link - Cloud9 Resume</title>
        </Head>
  ...
  return (
    <>
      <Head>
        <title>Reset Password - Cloud9 Resume</title>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="confirm-password" className="block text-xs font-medium text-gray-700 uppercase tracking-wide mb-2">
                  Confirm Password
                </label>
                <input
                  id="confirm-password"
